defmodule MapmergeWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MapmergeWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/mapmerge_web/templates",
        namespace: MapmergeWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MapmergeWeb.LayoutView, "live.html"}
